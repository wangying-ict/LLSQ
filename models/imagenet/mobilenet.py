...
__all__ = ['MobileNet', 'mobilenet_han']
...
def mobilenet_han(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['mobilenet'], map_location='cpu'))
    return model
