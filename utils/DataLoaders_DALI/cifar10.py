...
if __name__ == '__main__':
    train_loader = get_cifar_iter_dali(type='train', image_dir='/home/zhaoxiandong/datasets/data.cifar10',
                                       batch_size=256,
                                       num_threads=4)
    print('start iterate')
    start = time.time()
    ...
    train_loader = get_cifar_iter_torch(type='train', image_dir='/home/zhaoxiandong/datasets/data.cifar10',
                                        batch_size=256,
                                        num_threads=4)
    print('start iterate')
    start = time.time()
