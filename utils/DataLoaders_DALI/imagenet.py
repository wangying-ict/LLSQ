...
if __name__ == '__main__':
    train_loader = get_imagenet_iter_dali(type='train', image_dir='/home/zhaoxiandong/datasets/data.imagenet',
                                          batch_size=128,
    ...
    train_loader = get_imagenet_iter_torch(type='train', image_dir='/home/zhaoxiandong/datasets/data.imagenet',
                                           batch_size=128,
                                           num_threads=4, crop=224, device_id=0, num_gpus=1)
    print('start iterate')
    start = time.time()
